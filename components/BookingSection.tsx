        ...
        {editMode && tc ? (
          <>
            <textarea
              ...
              rows={2}
              className="w-full resize-none border border-white/30 bg-transparent px-1 py-1 font-[family-name:var(--font-anton)] text-4xl uppercase leading-tight text-white outline-none focus:border-white/60 sm:text-5xl"
            />
            <textarea
              value={body}
            ...
            <label className="flex w-full max-w-md flex-col gap-1 font-[family-name:var(--font-inter)] text-xs uppercase tracking-wide text-white/80">
              ...
              <input
                ...
                className="border-0 bg-black px-6 py-3 font-bold uppercase tracking-wide text-white outline-none ring-2 ring-white/30 focus:ring-white/60"
              />
            </label>
          </>
        ) : (
